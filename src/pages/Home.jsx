...
function BentoPreview() {
    ...
    const items = [
        ...
        { title: '편집', en: 'POST-PRODUCTION', desc: '영상편집 · 모션그래픽 · 디자인 · AI', span: isMobile ? 'span 1' : 'span 1', h: '280px', accent: 'var(--tone-cool)', reelUrl: '#edit' },
        { title: '3D', en: '3D VISUALIZATION', desc: '제품 렌더링 · 애니메이션 · 비주얼', span: isMobile ? 'span 1' : 'span 1', h: '280px', accent: 'var(--tone-vivid)', reelUrl: '#3d' },
        // Development & Full Portfolio: Full width on mobile
        { title: '개발', en: 'DEVELOPMENT', desc: '웹앱 · 자동화 · AI 통합', span: isMobile ? 'span 1' : 'span 2', h: '200px', accent: 'var(--tone-mint)', reelUrl: '#dev' },
